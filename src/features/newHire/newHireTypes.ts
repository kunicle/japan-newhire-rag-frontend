...
export interface NewHireProvisioningInput { email: string; password: string; employeeNumber: string; employeeName: string; departmentId: number; jobGradeId: number; hireDate: string; managerEmployeeId?: number | null }
...
export interface NewHireFormValues { email: string; password: string; employeeNumber: string; employeeName: string; departmentId: string; jobGradeId: string; hireDate: string; managerEmployeeId?: string }
