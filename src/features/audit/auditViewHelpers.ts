...
const ACTION_LABELS: Record<string, string> = { EMPLOYEE_DEPARTMENT_CHANGED: '직원 부서 변경', EMPLOYEE_JOB_GRADE_CHANGED: '직원 직급 변경', DEPARTMENT_CREATED: '부서 생성', DEPARTMENT_UPDATED: '부서 정보 수정', USER_CREATED: '사용자 생성', ACCOUNT_ACTIVATED: '계정 활성화', ACCOUNT_DEACTIVATED: '계정 비활성화', ROLE_GRANTED: '역할 부여', ROLE_REVOKED: '역할 해제', DIRECT_MANAGER_CHANGED: '직속 관리자 변경', EVALUATION_RESULT_PUBLISHED: '평가 결과 발행' }
const TARGET_LABELS: Record<string, string> = { DEPARTMENT: '부서', APP_USER: '사용자', USER_ROLE: '사용자 역할', EMPLOYEE: '직원', EVALUATION: '평가' }
